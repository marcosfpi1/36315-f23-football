---
title: "Final Project - 2021-2022 Football Player Stats"
author: "Anusha Bhat, Marcos Pi Marrero, Nandini Neralagi, Noelani Phillips"
output:
  pdf_document:
  html_document:
    toc: no
...
3.  Your dataset should have at least 200 usable observations after any pre-processing has been done.  Exceptions might be made to this rule, but a lot of the graphical techniques we will study produce rather uninteresting results on tiny datasets.


***


#  How do metrics related to offensive performance, including passing and goals, differ across player position and league? 
...
***
#  How do metrics related to defensive performance differ across player position?
